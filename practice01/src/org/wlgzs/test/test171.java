...
public class test171 {
    ...
    public static void main(String[] args) {
        String[] time= new String[] {"zero","one","two","three","four","five","six","seven","eight","nine","ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen","twenty","thirty","forty","fifty"};
        ...
        if(m==0) {
            ...
            if(h<=20)
                System.out.println(time[h]+" "+time[m/10-2+20]+" "+time[m%10]);
            else if(h>20)
                System.out.println("twenty"+" "+time[h-20]+" "+time[m/10-2+20]+" "+time[m%10]);
        }
    }
}
